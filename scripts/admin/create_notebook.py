...
cells.append(
    new_markdown_cell(
        """# Car Price Prediction - ML Algorithm Comparison
...
cells.append(
    new_code_cell(
        """# Define all models (tuned hyperparams where available)
models = {
...
cells.append(
    new_markdown_cell(
        """### 4c. Radar Chart - Multi-dimensional Comparison
...
# Write notebook
output_path = "notebooks/car_price_ml_comparison.ipynb"
